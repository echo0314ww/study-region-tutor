...
const releaseGuidesByVersion: Record<string, ReleaseGuideContent> = {
  ...
  '1.3.0': {
    ...
    steps: [
      {
        title: '界面可以切换主题',
        body: '设置页新增主题选项，可以选择亮色、暗色或跟随系统，所有主要界面都已适配暗色主题。',
        action: '如果夜间学习或跟随系统深色模式，建议在设置页切换主题后检查当前显示效果。'
      },
      {
        title: '错题统计更直观',
        body: '学习库新增数据统计入口，会展示总数、待复习、错题数、掌握率、学科分布、知识点和易错点统计。',
        action: '复习前先查看数据统计，可以快速定位薄弱学科和高频易错点。'
      },
      {
        title: '学习数据可以备份恢复',
        body: '学习库新增 JSON 备份导出和导入，导入时可以选择替换、合并优先导入或合并优先本地。',
        action: '换电脑或大改学习库前，先导出备份；导入时按是否信任备份内容选择合并策略。'
      },
      {
        title: '学习库和评测更稳',
